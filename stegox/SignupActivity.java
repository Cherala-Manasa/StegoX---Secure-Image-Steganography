...
public class SignupActivity extends AppCompatActivity {
    ...
    public void openTermsAndPolicy(View view) {
        // Open the Terms & Privacy Policy URL
    ...
    private void saveUserData() {
        ...
        if (dbHelper.isEmailExists(email)) {
            Toast.makeText(SignupActivity.this, "Email already exists. Please use a different email.",
    ...
    public void onBackPressed() {
        super.onBackPressed(); // Call the parent class's onBackPressed method to handle the back press
                               // behavior
