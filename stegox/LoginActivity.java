...
import org.stegox.DatabaseHelper;
import org.stegox.ForgotPasswordActivity;
import org.stegox.MainActivity;
import org.stegox.R;
import org.stegox.SignupActivity;

import org.stegox.WelcomeActivity;
            ...
            if (isValidInput()) {
                ...
                if (isUserValid) {
                    ...
                    if (dbHelper.isEmailExists(email)) {
                        ...
                        Toast.makeText(LoginActivity.this, "Email not registered. Please sign up.", Toast.LENGTH_SHORT)
                                .show();
                    }
                }
            }
